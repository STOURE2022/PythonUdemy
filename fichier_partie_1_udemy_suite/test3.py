...
print(f"[DEBUG] Fin de boucle principale : bandit_resiste={user_bandit_resiste}, policier_resiste={user_policier_resiste}, vie_bandit={vie_bandit}, vie_policier={vie_policier}, papier_1={user_papier_1}, papier_2={user_papier_2}")
